...
<main class="app-content">
    ...
    <div class="col-md-6" style="text-align:left;">
        <div class="tile">
            ...
            <div class="tile-body">
                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="category-form-process.php">
                    <div class="form-group row">
                        <label class="control-label col-md-3">Category Name</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text" placeholder="Enter category's name" name="category_name" required>
                        </div>
                    </div>
            </div>
